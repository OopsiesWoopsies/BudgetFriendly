...
function insertNewBudgetSheet(id, title, created_at, budget) {
  return db
    .prepare('INSERT INTO budget_sheets (id, title, created_at, budget) VALUES (?, ?, ?, ?)')
    .run(id, title, created_at, budget);
}
